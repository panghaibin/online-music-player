...
function scrollLyric(time) {
    ...
    var scroll = ((0 + lyricArea.children().height()) * i) - ($(".lyric").height() / 2) ; 
    lyricArea.stop().animate({scrollTop: scroll}, 0);  // 平滑滚动到当前歌词位置(更改这个数值可以改变歌词滚动速度，单位：毫秒)
...
(function() {
    ...
    if (typeof window.screenX === "number") {
        var eleFull = document.querySelector(".lyric");
